...
enum L10n {
    ...
    private static func string(_ key: String) -> String {
        let table: [String: [String: String]] = [
            ...
            "store_summary_free": ["it": "3 scansioni camera/giorno. Lezioni sempre gratuite", "en": "3 camera scans/day. Lessons always free", "fr": "3 scans caméra/jour. Leçons toujours gratuites", "es": "3 escaneos de cámara/día. Lecciones siempre gratis", "uz": "Kuniga 3 ta kamera skani. Darslar doim bepul"],
            "store_summary_premium": ["it": "Scansioni camera illimitate. Lezioni sempre gratuite", "en": "Unlimited camera scans. Lessons always free", "fr": "Scans caméra illimités. Leçons toujours gratuites", "es": "Escaneos ilimitados. Lecciones siempre gratis", "uz": "Cheksiz kamera skanlari. Darslar doim bepul"],
