...
enum SubscriptionTier: String, CaseIterable, Codable {
    ...
    var featureSummary: String {
        switch self {
        case .free:
            return "5 camera scans/day and standard lesson rewards"
        case .pro:
            return "10 camera scans/day and boosted lesson rewards"
        case .max:
            return "Unlimited camera scans and full lesson refunds"
        }
    }
